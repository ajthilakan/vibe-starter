...
Template repo for [vibe30](https://ajthilakan.com) apps. Vite + vanilla TypeScript, with CI (build + secret-scan) and house rules already wired. Spin a new app from it instead of scaffolding from scratch.
...
One-line description. [Live](https://vibe-SLUG.pages.dev) · part of the [vibe30 index](https://ajthilakan.com).
